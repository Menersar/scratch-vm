...
class Scratch3PenBlocks {
    ...
    static get STATE_KEY () {
        ...
        // !!! ???
        // Note: For a slight increase in performance, this value is hardcoded in some places.
        // Those parts have to be updated if this value is changed here.
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    // ??? The declared value 'args' is never read? !!!
    penDown (args, util) {
        // const target = util.target;
    ...
    // !!! Does compiler utilize this function? ???
    ...
    _changePenShadeBy (shade, target) {
        ...
        this.setPenShadeToNumber(penState._shade + shadeChange, target);
    }
