...
const iconURI = `data:image/svg+xml;base64,${btoa('<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"><polygon style="stroke: rgb(255, 255, 255); fill: rgb(182, 213, 151); paint-order: fill; fill-rule: nonzero; stroke-opacity: 1;" stroke-linecap="round" stroke-linejoin="round" points="320.977 270.739 307.238 312.501 329.578 295.119 324.558 327.547 299.067 358.013 296.512 376.645 300.575 359.452 328.962 334.324 345.538 271.707 319.607 294.672 326.33 274.686 351.601 245.266" /></svg>')}`;
...
/**
 * Class for Sidekick blocks
 * @constructor
 */
class SidekickBlocks {
    constructor (runtime) {
        /**
    ...
    getInfo () {
        return {
            ...
            color3: '#63a93d',
            // !!! CHANGE !!!
            // docsURI: 'https://github.com/Mixality/Sidekick#blocks',
            docsURI: 'https://github.com/Menersar/Sidekick#blocks',
            menuIconURI: iconURI,
            ...
            menus: {
                mouseButton: {
                    items: [
                        {
                            text: formatMessage({
                                id: 'gui.blocks.mouseButton.primary',
                                default: '(0) primary',
                        ...
                        {
                            text: formatMessage({
                                id: 'gui.blocks.mouseButton.middle',
                                default: '(1) middle',
                        ...
                        {
                            text: formatMessage({
                                id: 'gui.blocks.mouseButton.secondary',
                                default: '(2) secondary',
