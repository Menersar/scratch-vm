...
class Mouse {
    ...
    /**
     * tw: Get the down state of a specific mouse button.
     * @param {number} button - the button ID of the. `0` for left mouse button; `1` for middle mouse button; `2` for right mouse button.
