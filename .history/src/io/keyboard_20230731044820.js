...
class Keyboard {
    ...
    _keyStringToScratchKey (keyString) {
        ...
        // Key case it needed for track keeping.
        return keyString;
    ...
    postData (data) {
        ...
        // !!! 'changes in '_keyStringToScratchKey''? ???
        // Uppercase conversion of single letter keys because of changes in '_keyStringToScratchKey'.
    ...
    // Exposure of the last key pressed.
    getLastKeyPressed () {
