...
const getExtensionURLsToSave = (extensionIDs, runtime) => {
    // !!! ???
    // extensionManager only exists if runtime is wrapped by VirtualMachine.
    ...
    //   "otherid": "https://..."
    // }
    // In order to pass the information to the VM which URLs correspond to which IDs (which is useful when the project
    // is being loaded.
    // For example, if the extension is eventually converted to a builtin extension
