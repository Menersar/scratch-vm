...
class Runtime extends EventEmitter {
     ...
     * @param {string[]} [options.arguments] - optional: Names of the arguments accepted.
     * @param {boolean} [options.hidden] - specifies if the block should be included in the block palette. Set `true` if it should be included.
