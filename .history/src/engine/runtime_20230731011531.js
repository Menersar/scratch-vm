...
class Runtime extends EventEmitter {
    ...
    /**
     * @param {string} method - the name of the method for the 'external communication' feature in 'Runtime.externalCommunicationMethods'.
     * @param {boolean} enabled - `true` to enable if the 'external communication' feature; `false` to disable.
     */
