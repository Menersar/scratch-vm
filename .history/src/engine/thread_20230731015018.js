...
class Thread {
    constructor (firstBlock) {
        ...
        // The compiler data.
        // Note: For these values to make sense, 'isCompiled' must be '== true'.
        this.timer = null;
        /**
    ...
    static getIdFromTargetAndBlock (target, topBlock) {
        // Use the '&' character as a separator, as it should not appear in an ID.
    ...
    tryCompile () {
        ...
        // !!! ???
        // To avoid circular dependency issues: Import the compiler here.
