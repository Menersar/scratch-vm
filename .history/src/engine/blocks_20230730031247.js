...
class Blocks {
    constructor (runtime, optNoGlow) {
        ...
        this._cache = {
            ...
            // ??? should it be 'threads' or 'heads' (in the following comment) instead of 'theads'? ???
            /**
            ...
            /**
             * A cache of top block opcodes to compiled scripts.
             * Is not exclusively equivalent to hat block opcodes − although in most cases it is.
             * @type {object.<string, object>}
             */
            compiledScripts: {},

            /**
             * A cache of procedure code opcodes to a parsed intermediate representation.
             * @type {object.<string, object>}
             */
            compiledProcedures: {},

            /**
             * A flag indicating whether 'populateProcedureCache' has been executed.
             */
    ...
    getProcedureDefinition (name) {
        ...
        for (const id in this._blocks) {
            ...
            if (block.opcode === 'procedures_definition') {
                // 'populateProcedureCache' must be up-to-date with this method.
    ...
    /**
     * Initiate 'procedureParamNames' and 'procedureDefinitions' together in one call to increase speed of following calls to these methods.
     */
