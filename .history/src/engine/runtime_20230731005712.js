...
class Runtime extends EventEmitter {
    ...
    /**
     * Set interpolation.
     * @param {boolean} interpolationEnabled - `true` to enable interpolation.
     */
     ...
     * @param {boolean} [options.hidden] - specification if the block should be included in the block palette. Set to `true` if the block should be included in the block palette.
