...
class Runtime extends EventEmitter {
    constructor () {
        ...
        /**
         * Defines whether user privacy related features (e.g. reading data from a webcam) are enabled as long as the project accesses external communication methods to protect a user's privacy.
