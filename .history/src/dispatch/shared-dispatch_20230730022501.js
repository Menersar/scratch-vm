...
class SharedDispatch {
    ...
    _remoteTransferCall (provider, service, method, transfer, ...args) {
        return new Promise((resolve, reject) => {
            ...
            // Args list: [args, util, real block info]
            // Just send args from the args list ([args, util, real block info]).
            // The other elements throw errors when trying to clone them.
            // !!! ???
    ...
    _deliverResponse (responseId, message) {
        try {
            ...
            // !!! why 'JSON.stringify' not needed here ???
