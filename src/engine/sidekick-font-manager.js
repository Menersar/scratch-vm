...
const AssetUtil = require('../util/sidekick-asset-util');
const StringUtil = require('../util/string-util');
const log = require('../util/log');

/**
 * @typedef InternalFont
 * @property {boolean} system - `true` if the font is built in to the system; `false` if not.
 * @property {string} family - name of the font.
 * @property {string} fallback - fallback font family list.
 * @property {Asset} [asset] - scratch-storage asset; `false` if system.
 */
...
class FontManager extends EventEmitter {
    ...
    /**
     * @param {string} family - new (i.e. unknown) font family.
     * @returns {boolean} `true` if the family is valid; `false` if not.
     */
