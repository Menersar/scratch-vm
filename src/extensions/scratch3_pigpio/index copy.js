...
var Scratch3PiGPIOBlocks = /*#__PURE__*/function () {
  _createClass(Scratch3PiGPIOBlocks, null, [{
    key: "EXTENSION_NAME",
  ...
  function Scratch3PiGPIOBlocks(runtime) {
    _classCallCheck(this, Scratch3PiGPIOBlocks);
  ...
  _createClass(Scratch3PiGPIOBlocks, [{
    key: "getInfo",
    ...
    key: "set_pull",
    value: function set_pull(args) {
      var pin = Cast.toNumber(args.GPIO);
      var val = Cast.toString(args.PULL);
      var op = 2;
      if (val == 'low') op = 1;
      if (val == 'none') op = 0;
      gpio.pull(pin, op);
