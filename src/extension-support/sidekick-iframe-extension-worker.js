...
const frameSource = require('./sidekick-load-script-as-plain-text!./sidekick-iframe-extension-worker-entry');
...
class IframeExtensionWorker {
    constructor () {
        ...
        this.iframe.className = 'sidekick-custom-extension-frame';
